...
echo.
echo ============================================================
echo Desinstalando aplicaciones de Microsoft Store
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Desinstalando aplicaciones de third-party apps (terceros)
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando funcion de Recall ( capturas de pantalla en segundo plano )
echo ============================================================
echo.
DISM /Online /Disable-Feature /FeatureName:Recall
echo.
echo ============================================================
echo Deshabilitando funcion de Hyper-V ( capturas de pantalla en segundo plano )
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Eliminando bloatware de Microsoft Edge
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando Consumer Features ( conjunto de experiencias y funcionalidades diseñadas para los usuarios domésticos o particulares )
echo ============================================================
echo.
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\CloudContent" /v "DisableWindowsConsumerFeatures" /t "REG_DWORD" /d "1" /f
echo.
echo ============================================================
echo Deshabilitando Servicio de Fax
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando Internet Explorer
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando Busqueda de Telemetria de Windows
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando windows search telemetria     
echo ============================================================
echo.
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Search" /v DisableWebSearch /t REG_DWORD /d 1 /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\Windows Search" /v ConnectedSearchUseWeb /t REG_DWORD /d 0 /f
...
echo.
echo ============================================================
echo Deshabilitando Telemetria de Office
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando Aplicaciones de experiencia de Telemetria
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando Aplicaciones de recopilacion de experiencia de Telemetria
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando verificacion de Telemetria de hardware
echo ============================================================
echo.
...
echo ============================================================
echo Deshabilitando Anuncios dirigidos y collecion de informacion
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Apagando opciones de consentiemiento de privacidad
echo ============================================================
echo.
reg add "HKCU\SOFTWARE\Microsoft\Personalization\Settings" /v "AcceptedPrivacyPolicy" /t REG_DWORD /d 0 /f
echo.
echo ============================================================
echo Deshabilitando Sincronizacion en la nube
echo ============================================================
echo.
...
sc config BluetoothUserService start=delayed-auto
...
sc config PrintNotify start=delayed-auto
...
echo.
echo ============================================================
echo Opciones adicionales de optimizacion de rendimiento
echo ============================================================
echo.echo.
echo ============================================================
echo Deshabilitando transmision de informacion de mecanografia
echo ============================================================
echo.
reg add "HKCU\Software\Microsoft\Input\TIPC" /v "Enabled" /t REG_DWORD /d 0 /f
echo.
echo ============================================================
echo Deshabilitando contenido sugerido en Configuracion
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando sugerencia de completar configuracion del dispositivo
echo ============================================================
echo.
...
echo.
echo ============================================================
echo Deshabilitando notificaciones de aplicaciones desinstaladas
echo ============================================================
echo.
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "PostUpgradeMigration" /t REG_DWORD /d 0 /f
...
echo.
echo ============================================================
echo Deshabilitando acceso al idioma local para navegadores
echo ============================================================
echo.
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" /v "DisableLocation" /t REG_DWORD /d 1 /f
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" /v "DisableLocationScripting" /t REG_DWORD /d 1 /f
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\language" /v "Value" /t REG_SZ /d "Deny" /f
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\language" /v "Value" /t REG_SZ /d "Deny" /f
echo.
echo ============================================================
echo Deshabilitando sugerencias de texto al escribir en teclado
echo ============================================================
echo.
...
reg add "HKCU\Software\Microsoft\Input\Settings" /v "MultilingualEnabled" /t REG_DWORD /ed 0 /f
reg add "HKCU\Software\Microsoft\TabletTip\1.7" /v "EnableTextPrediction" /t REG_DWORD /d 0 /f
reg add "HKCU\Software\Microsoft\TabletTip\1.7" /v "EnableAutoCorrection" /t REG_DWORD /d 0 /f

echo.
echo ============================================================
echo Deshabilitando envio de URLs a la tienda de Windows
echo ============================================================
echo.
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\System" /v "DisableSmartScreen" /t REG_DWORD /d 1 /f
...
@REM msg * "Hemos finalizado el proceso, gracias por tu paciencia, el equipo se reiniciara, Hecho por Luis Hernandez (TechCode, 5620648883, estamos para servirte"

@REM powershell -Command "Add-Type -AssemblyName PresentationFramework; if ([System.Windows.MessageBox]::Show('Hemos finalizado el proceso, gracias por tu paciencia, el equipo se reiniciara, Hecho por Luis Hernandez (TechCode, 5620648883, estamos para servirte)', 'Reinicio requerido', 'OKCancel', 'Information') -eq 'OK') { Restart-Computer -Force }"

powershell -Command "Add-Type -AssemblyName PresentationFramework; if ([System.Windows.MessageBox]::Show('Hemos finalizado el proceso, gracias por tu paciencia, el equipo se reiniciara, Hecho por Luis Hernandez (TechCode, 5620648883, estamos para servirte)', 'Reinicio requerido', 'OK', 'Information') -eq 'OK') { Restart-Computer -Force }"
